            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  В React 19 для предоставления контекста потомкам можно использовать сам объект контекста как
                  JSX-компонент, вместо явного &lt;MyContext.Provider&gt;.
                </p>
                <p className="text-gray-700">Это делает код чище и понятнее, уменьшает количество шаблонного кода.</p>
              </div>

              <div>
                <h2 className="text-xl font-bold mb-3">Улучшения Ref API</h2>
                <p className="text-gray-700 mb-4">
                  Функциональные компоненты теперь могут принимать проп ref напрямую, без обёртки через
                  React.forwardRef.
                </p>
                <p className="text-gray-700">
                  Если вы объявите проп ref в списке параметров компонента, React автоматически будет передавать в него
                  родительский реф. Это упрощает типизацию в TypeScript и делает код более понятным.
                </p>
              </div>
            </div>
          }
