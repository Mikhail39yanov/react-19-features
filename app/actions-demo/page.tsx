import ActionsDemoForm from "../components/actions-demo-form"
import ServerActionDemo from "../components/server-action-demo"
import OldVsNewForm from "../components/old-vs-new-form"
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Actions - это новый подход к обработке форм и событий в React 19. Они представляют собой асинхронные
                  функции, которые можно привязать к событиям интерфейса вместо обычных обработчиков.
                </p>
                <p className="text-gray-700">
                  При вызове Action React выполняет его внутри перехода состояния (transitions), благодаря чему
                  обновления UI происходят без блокировки основного потока. React самостоятельно обрабатывает состояние
                  загрузки (pending), ошибки и оптимистичные обновления интерфейса.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Client Actions выполняются на клиенте и могут использовать хук useActionState для управления
                  состоянием. Этот хук возвращает текущее состояние, функцию-действие и флаг загрузки.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Server Actions - это функции, которые выполняются на сервере, но могут быть вызваны из клиентского
                  кода. Они помечаются директивой "use server" и могут иметь доступ к серверным ресурсам (БД, файловая
                  система).
                </p>
              </div>
