            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  В React 19 появилась встроенная поддержка управления метаданными документа. Теперь можно размещать
                  теги &lt;title&gt;, &lt;meta&gt;, &lt;link rel="stylesheet"&gt;, &lt;script async&gt; и др.
                  непосредственно в рендере компонентов.
                </p>
                <p className="text-gray-700">
                  React автоматически "поднимет" эти теги в секцию &lt;head&gt; итогового HTML-документа. Это работает
                  как при клиентском рендеринге, так и при серверном (включая стриминг) и даже в среде React Server
                  Components.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">React 19 автоматически перемещает в &lt;head&gt; следующие теги:</p>
                <ul className="list-disc list-inside text-gray-700 space-y-1">
