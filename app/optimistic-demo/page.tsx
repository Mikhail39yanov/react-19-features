  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
        Этот пример демонстрирует использование useOptimistic в React 19 для создания оптимистичных обновлений
        интерфейса.
      </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Оптимистичные обновления - это подход к разработке интерфейсов, при котором UI обновляется мгновенно,
                  не дожидаясь ответа от сервера. Это создает ощущение мгновенной реакции системы на действия
                  пользователя.
                </p>
                <p className="text-gray-700">
                  Если запрос к серверу завершается успешно, оптимистичное обновление остается. Если происходит ошибка,
                  интерфейс откатывается к предыдущему состоянию.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  React 19 представляет новый хук useOptimistic, который упрощает реализацию оптимистичных обновлений.
