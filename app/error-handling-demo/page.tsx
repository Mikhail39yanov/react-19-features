            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  React 19 значительно улучшил обработку ошибок, особенно в контексте гидратации и серверного
                  рендеринга.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>
                    <strong>Устойчивость к внешним изменениям DOM</strong> - React игнорирует лишние узлы, вставленные
                    сторонними скриптами или расширениями браузера.
                  </li>
                  <li>
                    <strong>Информативные сообщения об ошибках</strong> - при несоответствии HTML React выводит
                    подробное сообщение с возможными причинами проблемы.
                  </li>
                  <li>
                    <strong>Единообразное логирование ошибок</strong> - устранено двойное логирование ошибок в режиме
                    разработки.
                  </li>
                  <li>
                    <strong>Улучшенная интеграция с Suspense</strong> - ошибки, возникающие при загрузке данных через
                    Suspense, корректно перехватываются Error Boundary.
                  </li>
                </ul>
              </div>
