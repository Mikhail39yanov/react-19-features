  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
        Этот пример демонстрирует использование хука use в React 19 для работы с асинхронными данными.
      </p>
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="text-gray-600 mb-4">
                  В React 19 будет доступен новый хук use, который позволит "читать" значения промисов прямо в рендере
                  компонента. Это упростит работу с асинхронными данными и сделает код более декларативным.
                </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Хук use предоставляет удобный способ "прочитать" асинхронный ресурс (Promise) непосредственно во время
                  рендера компонента.
                </p>
                <p className="text-gray-700">
                  Раньше, чтобы получить данные в компоненте, приходилось либо использовать эффект useEffect и хранить
                  состояние с результатом, либо применять сторонние библиотеки типа React Query. Теперь же можно просто
                  вызвать use(promise) внутри функции компонента.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Когда вы вызываете use(promise), React увидит, что вы пытаетесь использовать результат асинхронной
                  операции, и приостановит (suspend) рендер этого компонента, пока Promise не завершится. При этом
                  вместо компонента будет отображён ближайший Suspense fallback.
                </p>
                <p className="text-gray-700">
                  Когда Promise выполнится, React автоматически продолжит рендерить компонент, но уже с готовыми
                  данными.
                </p>
              </div>
