    ...
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-md border border-gray-200">
        ...
        <p className="text-sm text-gray-700">
          useOptimistic - это новый хук в React 19, который позволяет создавать оптимистичные
          обновления UI. Он принимает два аргумента:
        </p>
...
startTransition(() => {
  addOptimistic(newValue);
        ...
        <p className="text-xs text-gray-500 mt-2">
          Важно: оптимистичные обновления должны происходить внутри startTransition или действия
          формы.
        </p>
      </div>
    </div>
