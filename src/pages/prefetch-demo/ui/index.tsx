            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold mb-3">
                  Предварительная загрузка ресурсов в React 19
                </h2>
                <p className="text-gray-700 mb-4">
                  React 19 предоставляет API для предварительной загрузки важных ресурсов – чтобы
                  браузер начал их загружать до того, как они понадобятся. Эти функции позволяют
                  добавить в документ специальные &lt;link&gt; подсказки.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li>
                    <strong>prefetchDNS(url)</strong> - вставляет &lt;link rel="dns-prefetch"
                    href="..."&gt;, подсказывая браузеру заранее разрешить DNS-имя указанного хоста.
                  </li>
                  <li>
                    <strong>preconnect(url)</strong> - вставляет &lt;link rel="preconnect"
                    href="..."&gt;, инициируя заранее установление соединения с указанным хостом.
                  </li>
                  <li>
                    <strong>preload(url, options)</strong> - вставляет &lt;link rel="preload"
                    href="..."&gt; для начала загрузки указанного ресурса.
                  </li>
                  <li>
                    <strong>preinit(scriptUrl, options)</strong> - более "агрессивная" форма для
                    скриптов: вставляет тег &lt;script&gt; с атрибутом async.
                  </li>
                </ul>
              </div>
