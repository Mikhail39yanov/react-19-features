            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold mb-3">
                  Управление стилями и скриптами в React 19
                </h2>
                <p className="text-gray-700 mb-4">
                  React 19 внедрил нативную поддержку подключения стилей и скриптов из кода
                  компонентов, что особенно полезно в условиях клиентского Concurrent Rendering и
                  потокового SSR.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Введён специальный атрибут precedence для &lt;link rel="stylesheet"&gt; (а также
                  для инлайновых &lt;style&gt;), указывающий приоритет данного стиля. React будет
                  учитывать этот приоритет при вставке тегов стиля в DOM.
                </p>
                <p className="text-gray-700">
                  Если такой &lt;link&gt; рендерится внутри Suspense-границы, React обеспечит, что
                  соответствующий CSS-файл загрузится до того, как будет отображён контент,
                  зависящий от него (это предотвращает эффект FOUC – Flash of Unstyled Content).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  React 19 теперь поддерживает рендеринг &lt;script async&gt; внутри компонентов: вы
                  можете вставить тег &lt;script async src="..."&gt; прямо там, где он нужен в JSX,
                  не беспокоясь о его ручном перемещении в &lt;head&gt;.
                </p>
                <p className="text-gray-700">
                  React гарантирует, что такой скрипт будет выполнен только один раз, даже если
                  компонент, его содержащий, будет отрендерен несколько раз. Все дублирующиеся
                  экземпляры &lt;script async src="X"&gt; будут автоматически устранены.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  ...
                  <li>
                    Предотвращение FOUC (Flash of Unstyled Content) (мигание нестилизованного
                    контента)
                  </li>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-2">
                  Пример использования precedence для стилей
                </h3>
